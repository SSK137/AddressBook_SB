...
@ControllerAdvice
@Slf4j
public class AddressBookExceptipn {
    ...
    public ResponseEntity<ResponseDTO> handleMethodArgumentNotValidException(
        ...
        ResponseDTO responceDTO = new ResponseDTO(message,errMsg);
        return new ResponseEntity<>(responceDTO, HttpStatus.BAD_REQUEST);
    }
    @ExceptionHandler(AddressBookExceptionHandler.class)
    public ResponseEntity<ResponseDTO> handleEmployeePayrollException(AddressBookExceptionHandler exception){
